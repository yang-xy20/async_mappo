...
from onpolicy.envs.gridworld.gym_minigrid.roomgrid import RoomGrid
...
register(
    ...
    entry_point="onpolicy.envs.gridworld.gym_minigrid.envs:ObstructedMaze_2Dlh"
)

register(
    id="MiniGrid-ObstructedMaze-2Dlhb-v0",
    entry_point="onpolicy.envs.gridworld.gym_minigrid.envs:ObstructedMaze_2Dlhb"
)

register(
    id="MiniGrid-ObstructedMaze-1Q-v0",
    entry_point="onpolicy.envs.gridworld.gym_minigrid.envs:ObstructedMaze_1Q"
)

register(
    id="MiniGrid-ObstructedMaze-2Q-v0",
    entry_point="onpolicy.envs.gridworld.gym_minigrid.envs:ObstructedMaze_2Q"
)

register(
    id="MiniGrid-ObstructedMaze-Full-v0",
    entry_point="onpolicy.envs.gridworld.gym_minigrid.envs:ObstructedMaze_Full"
)