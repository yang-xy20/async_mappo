...
register(
    ...
    entry_point='onpolicy.envs.gridworld.gym_minigrid.envs:MemoryS13',
)
...
register(
    ...
    entry_point='onpolicy.envs.gridworld.gym_minigrid.envs:MemoryS11',
)
...
register(
    ...
    entry_point='onpolicy.envs.gridworld.gym_minigrid.envs:MemoryS9',
)
...
register(
    ...
    entry_point='onpolicy.envs.gridworld.gym_minigrid.envs:MemoryS7',
)
