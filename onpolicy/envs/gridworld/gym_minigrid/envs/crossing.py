...
register(
    ...
    entry_point='onpolicy.envs.gridworld.gym_minigrid.envs:SimpleCrossingEnv'
)

register(
    id='MiniGrid-SimpleCrossingS9N2-v0',
    entry_point='onpolicy.envs.gridworld.gym_minigrid.envs:SimpleCrossingS9N2Env'
)

register(
    id='MiniGrid-SimpleCrossingS9N3-v0',
    entry_point='onpolicy.envs.gridworld.gym_minigrid.envs:SimpleCrossingS9N3Env'
)

register(
    id='MiniGrid-SimpleCrossingS11N5-v0',
    entry_point='onpolicy.envs.gridworld.gym_minigrid.envs:SimpleCrossingS11N5Env'
)
