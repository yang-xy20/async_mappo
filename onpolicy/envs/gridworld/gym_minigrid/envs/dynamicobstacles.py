...
register(
    ...
    entry_point='onpolicy.envs.gridworld.gym_minigrid.envs:DynamicObstaclesEnv'
)

register(
    id='MiniGrid-Dynamic-Obstacles-16x16-v0',
    entry_point='onpolicy.envs.gridworld.gym_minigrid.envs:DynamicObstaclesEnv16x16'
)
